...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/01.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/01.exe: ${OBJECTFILES}
...
${OBJECTDIR}/djutils.o: djutils.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/djutils.o djutils.cpp
